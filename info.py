...
#main variables
API_ID = int(environ.get('API_ID', '29343670'))
API_HASH = environ.get('API_HASH', '28010be97096919fe9511f8ddf1bfc54)
BOT_TOKEN = environ.get('BOT_TOKEN', '6880909457:AAGIMSvHx7GZzwuf-gvVEhYgzIvpdn4Sy78')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002205632774').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ericabraham016:ericabraham016@cluster0.zmtpq.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002167321022'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002216384862'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002190085895'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002185791146'))
